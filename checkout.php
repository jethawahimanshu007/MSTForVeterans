...
<!--
        ...
        <input type="hidden" name="hosted_button_id" value="D65LA8WAQ37WY">

        <input type="hidden" name="on0" value="10"><input type="hidden" name="os0" value="10" maxlength="200">

        <input type="image" src="images/shop/payButton.png" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
    ...
    -->
      ...
      <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top" class="pull-right">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="GW6GR9KWXYAW2">
<table>
<tr><td><input type="hidden" name="on0" value="price"><input type="hidden" name="os0" maxlength="200"></td></tr>
</table>
<input type="image" src="images/shop/payButton.png" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
</form>
    ...
    $("#paypalAmount").text("<?php echo ($total+2) ?>");
