					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><span>MST</span> for Veterans</h1>
									<h2>Meager selling charge</h2>
									<p>Amazon charges 10%, ebay charges 9%, we charge 3.5% because we love our veterans! </p>
									<button type="button" class="btn btn-default get">Get it now</button>
								</div>
								<div class="col-sm-6">
									<img src="images/home/savings.jpg" class="girl img-responsive" alt="" style="margin-top:100px;height:250px;width:500px;" />
								</div>
							</div>
							<div class="item">
								<div class="col-sm-6">
									<h1><span>MST</span> for Veterans</h1>
									<h2>Salute to our veterans</h2>
									<p>9% of overall businesses in America are owned by Veterans and we are proud to serve them! </p>
									<button type="button" class="btn btn-default get">Get it now</button>
								</div>
								<div class="col-sm-6">
									<img src="images/home/veterans.jpg" class="girl img-responsive" alt="" style="margin-top:100px;height:250px;width:500px;" />
								</div>
							</div>
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span>MST</span> for Veterans</h1>
									<h2>Ease</h2>
									<p>We are using Amazon's patented one click technology to make it even easier for users to buy! </p>
									<button type="button" class="btn btn-default get">Get it now</button>
								</div>
								<div class="col-sm-6 pull-right">
									<img src="" class="girl img-responsive" alt="" />
									<img src="images/home/ease.jpg" class="pricing pull-right" alt="" style="margin-top:100px;height:250px;width:500px;"/>
								</div>
							</div>
