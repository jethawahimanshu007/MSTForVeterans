		...
		<div class="container">
			<div class="row">
                ...
                <?php
                  ...
                  $sql = "select * from PRODUCT_TBL WHERE productId=".$_POST['productId']."";
                  ...
                  $sql = "select * from PRODUCT_TBL WHERE categoryId=".$categoryId." LIMIT 3";
                  $result = mysqli_query($connection, $sql) or die("Error in Selecting " . mysqli_error($connection));
                  $images=array(""); $i=0;
                  while($row =mysqli_fetch_assoc($result))
                  {
                      $images[$i]=$row['imagePath'];
                      $i++;
                  }

                  echo "<img src='".$imagePath."' alt='' height='300px' width='100px'/>
                  <h3>ZOOM</h3>
                </div>
                <div id='similar-product' class='carousel slide' data-ride='carousel'>
                    ...
                    <!-- Wrapper for slides -->
                      ...
                      <div class='item active'>
                        <a href=''><img src='".$images[0]."' alt='' height='35px' width='90px'></a>
                        <a href=''><img src='".$images[1]."' alt='' height='35px' width='90px'></a>
                        <a href=''><img src='".$images[2]."' alt='' height='35px' width='90px'></a>
                      </div>
                      <div class='item'>
                      <a href=''><img src='".$images[0]."' alt='' height='35px' width='90px'></a>
                      <a href=''><img src='".$images[1]."' alt='' height='35px' width='90px'></a>
                ...
                <div class='col-sm-7'>
                  <div class='product-information'><!--/product-information-->
                    ...
                    <h2>".$productName."</h2>
                    <p>Product ID: <span id='productId'>".$_POST['productId']."</span></p>
